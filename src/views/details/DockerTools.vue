<template>
    <div class="dockertools">
        ...
        <div class="content">
            <h1 style="margin: 20px 30px;font-size: 30px;color: #42b983">5款非常好用的 Docker工具</h1>
            ...
            <cod>$ docker run -d --name watchtower --rm -v /var/run/docker.sock:/var/run/docker.sock v2tec/watchtower --interval 30</cod>
            ...
            <code>$ docker run -p 4000:80 --name friendlyhello shekhargulati/friendlyhello:latest</code>
            ...
            <code>$ docker run --rm -v /var/run/docker.sock:/var/run/docker.sock -e DRY RUN=1 spotify/docker-gc</code>
            ...
            <code>[2017-04-28T06:27:24] [INFO] : The following container would have been removed 0c1b3b0972bb792bee508 60c35a4 bc08ba32b527d53eab173d12a15c28deb931/vibrant_ yonath
            ...
            <code>$ docker-slim build --http-probe friendlyhello</code>
            ...
            <code>$ rocker d build --push -var VERSION-1.0</code>
